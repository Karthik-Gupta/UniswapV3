...
async function main() {
  ...
  const weth9 = "0x38d71b1465e522fdac7a7405ccd547b1804a9a26";
  ...
  const router = await Router.deploy(factory.address, weth9);
  ...
  const nftDescriptor = await positionDescriptorFactory.deploy(
    ...
    ethers.utils.formatBytes32String("TSKETH")
  );
  ...
  const quoter = await Quoter.deploy(factory.address, weth9);
